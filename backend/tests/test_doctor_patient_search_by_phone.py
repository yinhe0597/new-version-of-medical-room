...
class DoctorPatientSearchByPhoneTestCase(unittest.TestCase):
    def setUp(self):
    ...
    def test_search_by_phone_returns_patient(self):
        resp = self.client.get(
            "/api/doctor/patient/search",
            query_string={"keyword": "1380013"},
        ...
        self.assertEqual(data[0]["phone"], "13800138000")
