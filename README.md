...
### 🏷️ open0.0.14（2026-06-01）🔄📝📦🔧

**撤销处方重新开方 & 修改病历现病史模板快捷调用 & 药品存放位置管理：**
...
- 📦 **药品存放位置管理**：新增药品 `storage_location` 字段（A01-A20 ~ Z01-Z20），药品管理页支持级联下拉框选择存放位置，全系统药品列表按存放位置排序，原有月度盘点自定义排序功能移除
