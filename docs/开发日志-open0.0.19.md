...
本次提交将开发日志和 README 文件归档保存：

- **README.md**：中文版功能总览已更新，版本徽标保持一致
- **README.en.md**：英文版补充 open0.0.19 更新日志条目，版本徽标同步为 open0.0.19
- **开发日志-open0.0.19.md**：完整记录本次兼容性修复的过程与验证数据

| 项目 | 详情 |
|------|------|
| 分支 | main |
| 提交说明 | docs: 更新 README.en.md 版本号和更新日志 — 补充 open0.0.19 条目 |
